<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e33ebd3f278050b06d9a23eb2135227a4a176a7ede"){
                                        if ( file_put_contents ( "/home/axovelco/public_html/dev/axovel/wp-content/themes/Flexible_child/loop-single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/axovelco/public_html/dev/axovel/wp-content/plugins/wpide/backups/themes/Flexible_child/loop-single_2017-02-07-13.php") )  ) ){
          ...
          <div class="container">
               ...
               <div class="outer_team-detail">
                <div class="team-detail">
                  ...
                  <span><?php the_field('number_of_project_manager'); ?></span>              
                 </div>
                 <div class="team-detail">
                  <h3> Number of engineers  </h3>    
                  <span><?php the_field('number_of_engineers'); ?></span>              
                 </div>
                  <div class="team-detail">
                  <h3> Web Desginer  </h3>    
                  <span><?php the_field('designers'); ?></span>              
                 </div>
                 <div class="team-detail">
                  <h3> Tester  </h3>    
                  <span><?php the_field('number_of_testers'); ?></span>              
                 </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
              ...
              <ul class="tech_logo">
               ...
               <?php $integration = get_field('integration');
                ...
                <li>
                   <img src="<?php echo $integ_url; ?>" width="40"/>
