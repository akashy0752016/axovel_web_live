<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e33ebd3f278050b06d9a23eb2135227a4a176a7ede"){
                                        if ( file_put_contents ( "/home/axovelco/public_html/dev/axovel/wp-content/themes/Flexible/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/axovelco/public_html/dev/axovel/wp-content/plugins/wpide/backups/themes/Flexible/functions_2017-02-08-06.php") )  ) ){
...
function et_add_mobile_navigation(){
	echo '<a href="#" id="mobile_nav" class="closed">' . '<span class="toggle_bar"><span></span><span></span><span></span></span>' /*. esc_html__( 'Navigation Menu', 'Flexible' )*/ . '</a>';
}
